...
<template>
  <section class="bg-gray-900 py-10">
    ...
    <div class="flex flex-row pb-10 justify-center items-center gap-5">
      <div class="">
        <input
          ...
          class="outline-none bg-gray-700 border-b-green-400 rounded-lg shadow-lg text-white border-b-2 p-2 px-10"
        />
      </div>
      <div>
        <button
          class="text-white block bg-green-400 rounded-md text-center text-lg shadow-lg p-2 px-6 hover:bg-gray-500"
          @click="searchGif"
        >
          Search
        </button>
    ...
    <div v-if="hasSearched" class="grid grid-cols-4 gap-6 px-10 py-16">
